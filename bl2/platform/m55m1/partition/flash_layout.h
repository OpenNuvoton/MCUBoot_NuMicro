...
#define FLASH_S_PARTITION_SIZE          (0x100000 - 0x20000)
#define FLASH_NS_PARTITION_SIZE         (0)
#define FLASH_MAX_PARTITION_SIZE        (0x100000)
 ...
 * swapping.
 */
#define FLASH_AREA_BL2_OFFSET      (0x100000)
